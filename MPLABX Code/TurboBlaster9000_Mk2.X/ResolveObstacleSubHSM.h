...
#ifndef OBSTACLE_HSM_H  // <- This should be changed to your own guard on both
#define OBSTACLE_HSM_H  //    of these lines
...
/**
 * @Function InitResolveObstacleSubHSM(void)
